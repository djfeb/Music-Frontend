...
3. Full Endpoint for all requests http://102.212.179.119:3000 
...
### Get Popular Artists
```bash
curl "http://102.212.179.119:3000/artists?sort=popularity&genre=afrobeats&order=desc&limit=10"
```

### Search for Songs
```bash
curl "http://102.212.179.119:3000/tracks/search/love"
```

### Get Artist's Complete Discography
```bash
# Get artist info
curl "http://102.212.179.119:3000/artists/4dpARuHxo51G3z768sgnrY"

# Get their albums
curl "http://102.212.179.119:3000/artists/4dpARuHxo51G3z768sgnrY/albums"

# Get their tracks
curl "http://102.212.179.119:3000/artists/4dpARuHxo51G3z768sgnrY/tracks"
```

### Database Statistics
```bash
curl "http://102.212.179.119:3000/stats"
```
